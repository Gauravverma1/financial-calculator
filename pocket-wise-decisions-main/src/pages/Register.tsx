    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-50 dark:bg-slate-950 px-4 transition-colors duration-300 bg-[radial-gradient(ellipse_80%_80%_at_50%_-20%,rgba(99,102,241,0.15),rgba(255,255,255,0))] dark:bg-[radial-gradient(ellipse_80%_80%_at_50%_-20%,rgba(99,102,241,0.22),rgba(255,255,255,0))]">
      <div className="w-full max-w-md p-8 rounded-2xl border border-white/20 dark:border-slate-800/80 bg-white/70 dark:bg-slate-900/70 backdrop-blur-xl shadow-2xl transition-all duration-300">
        <div className="flex flex-col items-center mb-6">
          ...
          <p className="text-slate-500 dark:text-slate-400 text-sm font-medium">Create your personal account today</p>
        </div>

        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-1.5">
            <label className="text-sm font-semibold text-slate-655 dark:text-slate-400">Username</label>
          ...
          <div className="space-y-1.5">
            <label className="text-sm font-semibold text-slate-655 dark:text-slate-400">Password</label>
            <div className="relative">
              <span className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-400">
                <Lock size={18} />
              </span>
          ...
          {success && <div className="text-xs text-emerald-600 dark:text-emerald-400 text-center font-medium bg-emerald-50/50 dark:bg-emerald-950/20 py-2 rounded border border-emerald-100 dark:border-emerald-900/30">{success}</div>}
        ...
        <div className="text-center text-sm text-slate-500 dark:text-slate-400 mt-6">
          ...
          <Link to="/login" className="text-primary dark:text-indigo-400 hover:underline font-semibold">
            Sign In
          </Link>
        </div>
      </div>
